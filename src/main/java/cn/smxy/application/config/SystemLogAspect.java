package cn.smxy.application.config;
...
public  class SystemLogAspect {    
	...
	//Service层切点    
	@Pointcut("@annotation(cn.smxy.application.config.SystemServiceLog)")    
	public  void serviceAspect() {    
	}    

	//Controller层切点    
	@Pointcut("@annotation(cn.smxy.application.config.SystemControllerLog)")    
