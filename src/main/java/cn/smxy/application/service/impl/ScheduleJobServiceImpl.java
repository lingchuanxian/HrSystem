...
import cn.smxy.application.quartz.QuartzJobFactory;
import cn.smxy.application.quartz.QuartzJobFactoryDisallowConcurrentExecution;
import cn.smxy.application.service.ScheduleJobService;
...
public class ScheduleJobServiceImpl extends AbstractService<ScheduleJob> implements ScheduleJobService {
	...
	public void addJob(ScheduleJob job) throws SchedulerException {
		...
		// 不存在，创建一个
		if (null == trigger) {
			Class clazz = ScheduleJob.CONCURRENT_IS.equals(job.getJobIsConcurrent()) ? QuartzJobFactory.class : QuartzJobFactoryDisallowConcurrentExecution.class;
	...
	public void init() throws Exception {
		...
		// 这里获取任务信息数据
		List<ScheduleJob> jobList = findAll();
